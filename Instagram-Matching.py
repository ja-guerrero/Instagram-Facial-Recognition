...
def facialPattern(Image_path):
    ...
    compare_rects = haar_cascade_face.detectMultiScale(
        gray_compare, scaleFactor=1.12, minNeighbors=3)
...
followers = client.get_followers(
    user=username, count=65000000, callback_frequency=45)
count = 0
...
Image(local, driver=webdriver.Chrome(executable_path=r'./'))
